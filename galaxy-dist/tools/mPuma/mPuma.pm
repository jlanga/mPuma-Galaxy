...
$classifier         = "./rdp_classifier-2.2.jar";
...
#Classic
$primer_file    = "./primers-enumerated-3primeN.msf";
# rpoB
#$primer_file   = "$ENV{mPUMA}/reference_fasta/rpoB-primers.fna.enumerated";
$cpnDB_nr_nuc   = "./cpndb_nr_20140327";
$cpnDB_nr_pep   = "./cpndb_nr_pep_20140327";
$VERBOSE    = 0;

# These are internal programs within mPUMA and you should not need to edit these unless you are a developer
$translateStranded      = "./translate_stranded.pl";
$watered_blast          = "./watered_blast.pl";
$calculate_sp_sn_metrics    = "./calculate_Sp_Sn_metrics.pl";
$parseCDHitEst          = "./parse_cd-hit-est.pl";
$convertTechCmd         = "./convert_technology.pl";
$fixStrand          = "./fix_strandedness.pl";
$generateDiversity      = "./generate_diversity_from_toc.pl";
$createMeganInput       = "./create_input_megan.pl";
$createMeganBlastxInput     = "./create_blastx_input_megan.pl";
$createMeganCSVInput        = "./create_CSV_input_megan.pl";
$createMeganClassifierInput = "./create_input_megan_classifier.pl";
$createMothurInput      = "./create_input_mothur.pl";
$createUnifracInput     = "./create_input_unifrac.pl";
$makeToc            = "./make_toc.pl";
...
sub make_total_toc {
    my $tocFile = shift;
    die "Error lost tocFile" unless defined $tocFile;
...
sub removePossibleChimeras {
    ...
    unless (-s $chimericIDs){
        system("./c3extractChimericIDs.pl",
            '-i',   $c3report,
    ...
    unless(-s $noChimeraFile){
        system("./make_fasta_excluding_IDs.pl",
            '-i',   $fastaFile,
            '-e',   $chimericIDs,
...
sub generateClassifierProfilesFromMegan{
    ...
    unless (-s $output_file){
        system("./convert_classifier_to_profile.pl",
...
#               system("./sffToFastq.pl",'-i',$file,'-o',join('/',$NGSdir,$basename),'-z',1) == 0 
